...
export const productCreateReducer = (state = {}, action) => {
    switch (action.type) {
        case ProductConstant.PRODUCT_CREATE_REQUEST:
            return { loading: true }
...
export const productUpdateReducer = (state = { product: {} }, action) => {
    switch (action.type) {
        case ProductConstant.PRODUCT_UPDATE_REQUEST:
            return { loading: true }
...
export const productReviewCreateReducer = (state = {}, action) => {
    switch (action.type) {
        case ProductConstant.PRODUCT_CREATE_REVIEW_REQUEST:
            return { loading: true }
        case ProductConstant.PRODUCT_CREATE_REVIEW_SUCCESS:
            return { loading: false, success: true }
        case ProductConstant.PRODUCT_CREATE_REVIEW_FAIL:
            return { loading: false, error: action.payload }
        case ProductConstant.PRODUCT_CREATE_REVIEW_RESET:
            return {}
        default:
            return state
    }
...
export const productTopRatedReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        case ProductConstant.PRODUCT_TOP_REQUEST:
            return { loading: true, products: [] }
        case ProductConstant.PRODUCT_TOP_SUCCESS:
            return { loading: false, products: action.payload }
        case ProductConstant.PRODUCT_TOP_FAIL:
            return { loading: false, error: action.payload }
        default:
            return state
    }
